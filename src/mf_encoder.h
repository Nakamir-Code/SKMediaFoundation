...
namespace nakamir {
	...
	void mf_encode_sample_to_buffer(/**[in]**/ IMFSample* pVideoSample, /**[in]**/ IMFTransform* pEncoderTransform, /**[in]**/ const std::function<void(IMFSample*)>& onReceiveEncodedBuffer);
